...
//@Config
@TeleOp(name = "Smooth Rotation Drum")
public class TournamentOpMode2 extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            drumMotor.setPower(0.3 * gamepad2.right_trigger - 0.3 * gamepad2.left_trigger);
